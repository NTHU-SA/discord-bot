...
const htmlBotName = BOT_NAME.replaceAll("&", "&amp;")
  .replaceAll('"', "&quot;")
  .replaceAll("'", "&#39;");
...
<main><nav><a href="/calendar">discord-calendar</a> / ${htmlBotName}</nav>${content}<footer>Operated for the National Tsing Hua University Student Association.<br>Contact: <a href="mailto:admin@nthusa.tw">admin@nthusa.tw</a> · <a href="/calendar/privacy">Privacy policy</a></footer></main></html>`;
